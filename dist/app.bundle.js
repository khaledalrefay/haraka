(() => {
  ...
  function renderPlayer(active2) {
    ...
    const position = s.round ? `\u0627\u0644\u062F\u0648\u0631\u0629 ${s.round} \u0645\u0646 ${s.rounds}` : s.set ? `\u0627\u0644\u0645\u062C\u0645\u0648\u0639\u0629 ${s.set} \u0645\u0646 ${s.sets}` : "";
    const context = [s.round ? `\u0627\u0644\u0645\u062D\u0637\u0629 ${s.station} \u0645\u0646 ${s.stations}` : "", s.side ? `${s.side === "right" ? "\u064A\u0645\u064A\u0646" : "\u064A\u0633\u0627\u0631"} \u2014 ${e?.counting.side_means || ""}` : ""].filter(Boolean).join(" \xB7 ");
    ...
    return `<section class="v-player"><div class="v-player-head"><span>${names[w.program]} \xB7 ${w.session} \xB7 \u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${w.level}</span>${button("\u062E\u0631\u0648\u062C", "leave", "text-btn")}</div><div class="v-segments" aria-label="\u0627\u0644\u062E\u0637\u0648\u0629 ${active2.cursor + 1} \u0645\u0646 ${total}">${active2.snapshot.steps.map((_, i) => `<i class="${i < active2.cursor ? "done" : i === active2.cursor ? "current" : ""}"></i>`).join("")}</div><div class="card v-stage ${isRest ? "v-rest" : "v-work"}"><header class="v-exercise-heading"><div class="v-phase-row"><span class="v-phase">${isRest ? "\u0627\u0633\u062A\u0631\u0627\u062D\u0629 \xB7 " : ""}${phase}</span>${position || context ? `<div class="v-position muted">${position ? `<span>${esc(position)}</span>` : ""}${context ? `<span class="v-context">${esc(context)}</span>` : ""}</div>` : ""}</div><div class="v-title"><h1>${isRest ? "\u0648\u0642\u062A \u0644\u0644\u0631\u0627\u062D\u0629" : esc(movementName(s, active2.snapshot.exercises))}</h1>${!isRest ? button('<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 10v7M12 6v2"/></svg>', "instruction", "icon-btn", `data-id="${e.id}" aria-label="\u0643\u064A\u0641\u064A\u0629 \u0627\u0644\u0623\u062F\u0627\u0621"`) : ""}</div></header>${isRest ? `<div class="v-rest-center"><div class="v-clock" id="clock-ring"><span id="timer-text"></span></div><p class="small muted">\u0627\u0644\u062A\u0627\u0644\u064A: ${esc(next ? movementName(next, active2.snapshot.exercises) : "\u0627\u0646\u062A\u0647\u0627\u0621 \u0627\u0644\u062C\u0644\u0633\u0629")}</p></div>` : `<figure class="v-exercise-image is-loading" aria-busy="true"><div class="v-image-frame"><img src="assets/exercise-images/march.jpg" alt="\u0639\u064A\u0646\u0629 \u0645\u0624\u0642\u062A\u0629 \u0644\u0635\u0648\u0631\u0629 \u0627\u0644\u0645\u0634\u064A \u0644\u0627\u062E\u062A\u0628\u0627\u0631 \u0627\u0644\u0639\u0631\u0636" decoding="async"><span class="v-image-fallback" hidden>\u062A\u0639\u0630\u0651\u0631 \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0639\u064A\u0646\u0629 \u2014 \u0627\u0641\u062A\u062D \u0643\u064A\u0641\u064A\u0629 \u0627\u0644\u0623\u062F\u0627\u0621</span></div><figcaption>\u0639\u064A\u0646\u0629 \u0639\u0631\u0636 \u0645\u0624\u0642\u062A\u0629 \xB7 \u0644\u064A\u0633\u062A \u0634\u0631\u062D\u064B\u0627 \u0644\u0644\u062A\u0645\u0631\u064A\u0646 \u0627\u0644\u062D\u0627\u0644\u064A</figcaption></figure><div class="v-dose-panel"><div class="v-target"><span class="small muted">\u0627\u0644\u0647\u062F\u0641</span><strong class="v-goal">${goal(s)}</strong></div>${timed ? '<div class="v-timer-readout"><span class="small muted">\u0627\u0644\u0648\u0642\u062A \u0627\u0644\u0645\u062A\u0628\u0642\u064A</span><div class="timer-value" id="timer-text"></div></div>' : ""}${cue ? `<p class="v-cue">${esc(cue)}</p>` : ""}</div>`}<div class="v-controls">${timerControls}${button(isRest ? "\u0625\u0646\u0647\u0627\u0621 \u0627\u0644\u0631\u0627\u062D\u0629" : "\u0623\u0646\u0647\u064A\u062A \u0627\u0644\u062A\u0645\u0631\u064A\u0646", isRest ? "finish-rest" : "done", "primary full v-finish")}</div></div><div class="v-session-footer">${button(isRest ? "\u062A\u062E\u0637\u064A \u0627\u0644\u0631\u0627\u062D\u0629" : "\u062A\u062E\u0637\u064A \u0627\u0644\u062A\u0645\u0631\u064A\u0646", "skip", "secondary")}${button("\u0625\u0646\u0647\u0627\u0621 \u0627\u0644\u062C\u0644\u0633\u0629 \u0645\u0628\u0643\u0631\u064B\u0627", "stop", "text-btn")}</div></section>`;
  }
  ...
  function reduceSession(session, command2, now = Date.now()) {
    ...
    if (command2.type === "startTimer") {
      ...
      s.timer = { remainingMs: (remaining(s, now) ?? (step.seconds ?? step.target) * 1e3) + command2.seconds * 1e3, running: s.timer?.running ?? false, startedAt: s.timer?.running ? now : null };
  ...
  function preview(id) {
    ...
    show(`${modalHead2(`${names[snap.workout.program]} \xB7 ${snap.workout.session} \xB7 \u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${snap.workout.level}`)}${button("\u0645\u0642\u0627\u0631\u0646\u0629 \u0645\u0633\u062A\u0648\u064A\u0627\u062A \u0627\u0644\u0628\u0631\u0646\u0627\u0645\u062C", "browse-program", "text-btn", `data-id="${snap.workout.program}"`)}<p class="small muted">\u0627\u0644\u0645\u062F\u0629 \u0627\u0644\u0645\u062D\u0633\u0648\u0628\u0629 ${estimates[id].join("\u2013")} \u062F\u0642\u064A\u0642\u0629\u061B \u0627\u0644\u062A\u0642\u062F\u064A\u0631 \u0627\u0644\u0623\u0635\u0644\u064A ${snap.workout.plannedMinutes.join("\u2013")} \u062F\u0642\u064A\u0642\u0629. \u064A\u0634\u0645\u0644 \u0627\u0644\u062D\u0633\u0627\u0628 \u0627\u0644\u0631\u0627\u062D\u0629\u060C \u0648\u064A\u062E\u062A\u0644\u0641 \u062D\u0633\u0628 \u0633\u0631\u0639\u0629 \u0627\u0644\u0639\u062F\u0651\u0627\u062A \u0648\u062A\u0645\u062F\u064A\u062F\u0647\u0627. \u0644\u0645 \u062A\u064F\u0642\u064E\u0633 \u0627\u0644\u0645\u062F\u0629 \u0628\u062A\u062C\u0631\u0628\u0629 \u0641\u0639\u0644\u064A\u0629.</p>${["warmup", "main", "strength", "aerobic", "cooldown"].map((block) => {
  ...
  function home() {
    ...
    let card;
    if (active && selected === t) card = `<span class="pill">\u062C\u0644\u0633\u0629 \u0645\u062D\u0641\u0648\u0638\u0629</span><h2>${names[chosen.program]} \xB7 ${chosen.session}</h2><p>\u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${chosen.level}</p>${button("\u0623\u0643\u0645\u0644 \u062C\u0644\u0633\u062A\u0643", "resume", "primary")}`;
    else if (record) card = `<span class="pill">${record.status === "completed" ? "\u062C\u0644\u0633\u0629 \u0645\u0646\u062A\u0647\u064A\u0629" : "\u0627\u0646\u062A\u0647\u0627\u0621 \u0645\u0628\u0643\u0631"}</span><h2>${names[record.snapshot.workout.program]} \xB7 ${record.snapshot.workout.session}</h2>${record.hidden ? `<p>\u0647\u0630\u0647 \u0627\u0644\u062C\u0644\u0633\u0629 \u0645\u062E\u0641\u064A\u0629\u060C \u0648\u0645\u0627 \u0632\u0627\u0644 \u0645\u0648\u0639\u062F\u0647\u0627 \u0645\u062D\u062C\u0648\u0632\u064B\u0627.</p>${button("\u062D\u0630\u0641 \u0627\u0644\u062C\u0644\u0633\u0629 \u0648\u0625\u062A\u0627\u062D\u0629 \u0627\u0644\u0645\u0648\u0639\u062F", "delete-record", "secondary", `data-id="${esc(record.id)}"`)}` : button("\u0639\u0631\u0636 \u0627\u0644\u0633\u062C\u0644", "record", "primary", `data-id="${esc(record.id)}"`)}`;
    else if (chosen) card = `<span class="pill">${offer?.kind === "makeup" ? "\u062A\u0639\u0648\u064A\u0636 \u062C\u0644\u0633\u0629 \u0641\u0627\u0626\u062A\u0629" : selected === t ? "\u062C\u0644\u0633\u0629 \u0627\u0644\u064A\u0648\u0645" : "\u0645\u0639\u0627\u064A\u0646\u0629"}</span><h2>${names[chosen.program]} \xB7 \u0627\u0644\u062C\u0644\u0633\u0629 ${chosen.session}</h2><p>\u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${chosen.level}</p><p class="v-space small">${estimates[chosen.workoutId].join("\u2013")} \u062F\u0642\u064A\u0642\u0629 \u062A\u0642\u062F\u064A\u0631\u064A\u064B\u0627</p>${offer ? button("\u0627\u0628\u062F\u0623 \u0627\u0644\u062C\u0644\u0633\u0629", "start", "primary", `data-workout="${chosen.workoutId}"`) : ""}${button("\u0645\u0639\u0627\u064A\u0646\u0629 \u0627\u0644\u062A\u0645\u0627\u0631\u064A\u0646", "preview", "secondary", `data-workout="${chosen.workoutId}"`)}`;
  ...
  function hiddenHistory() {
    ...
    return rows.length ? `<details class="v-hidden-records"><summary>\u062C\u0644\u0633\u0627\u062A \u0645\u062E\u0641\u064A\u0629 \u0633\u0627\u0628\u0642\u064B\u0627 (${rows.length})</summary><p class="small muted">\u0627\u062D\u062A\u0641\u0638 \u0627\u0644\u0625\u0635\u062F\u0627\u0631 \u0627\u0644\u0633\u0627\u0628\u0642 \u0628\u0645\u0648\u0627\u0639\u064A\u062F\u0647\u0627. \u062D\u0630\u0641\u0647\u0627 \u0646\u0647\u0627\u0626\u064A\u064B\u0627 \u064A\u0632\u064A\u0644 \u062D\u062C\u0632 \u0627\u0644\u0645\u0648\u0639\u062F.</p>${rows.map((r) => `<div class="v-hidden-row"><span>${esc(r.dateKey)} \xB7 ${names[r.snapshot.workout.program]} ${r.snapshot.workout.session}</span>${button("\u062D\u0630\u0641 \u0646\u0647\u0627\u0626\u064A", "delete-record", "secondary v-delete", `data-id="${esc(r.id)}"`)}</div>`).join("")}</details>` : "";
  }
  function historyView() {
    return `<h1 class="v-space">\u0633\u062C\u0644\u0651\u064A</h1>${history.some((r) => !r.hidden) ? history.filter((r) => !r.hidden).sort((a, b) => b.finishedAt - a.finishedAt).map((r) => `<article class="card record"><div><small>${esc(r.dateKey)}</small><h3>${names[r.snapshot.workout.program]} \xB7 ${r.snapshot.workout.session} \xB7 \u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${r.snapshot.workout.level}</h3><span class="muted">${r.status === "completed" ? "\u0645\u0646\u062A\u0647\u064A\u0629" : r.endReason === "expired" ? "\u0627\u0646\u062A\u0647\u062A \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0627\u0633\u062A\u0643\u0645\u0627\u0644" : "\u0627\u0646\u062A\u0647\u0627\u0621 \u0645\u0628\u0643\u0631"}${r.results.some((x) => x.outcome === "skipped") ? " \xB7 \u0645\u0639 \u062A\u062C\u0627\u0648\u0632" : ""}</span></div><div class="v-record-actions">${button("\u0627\u0644\u062A\u0641\u0627\u0635\u064A\u0644", "record", "secondary", `data-id="${esc(r.id)}"`)}${button("\u062D\u0630\u0641 \u0627\u0644\u062C\u0644\u0633\u0629", "delete-record", "secondary v-delete", `data-id="${esc(r.id)}"`)}</div></article>`).join("") : '<section class="card empty"><p>\u0633\u062A\u0638\u0647\u0631 \u062C\u0644\u0633\u0627\u062A\u0643 \u0647\u0646\u0627 \u0628\u0639\u062F \u0627\u0646\u062A\u0647\u0627\u0626\u0647\u0627.</p></section>'}${hiddenHistory()}`;
  }
  function recordView(id) {
    const r = history.find((r2) => r2.id === id);
    show(`${modalHead2("\u062A\u0641\u0627\u0635\u064A\u0644 \u0627\u0644\u062C\u0644\u0633\u0629")}<p>${names[r.snapshot.workout.program]} \xB7 ${r.snapshot.workout.session} \xB7 \u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${r.snapshot.workout.level}</p><p class="muted">${r.dateKey}</p>${r.results.filter((x) => r.snapshot.steps.find((s) => s.id === x.stepId)?.type === "work").map((x) => {
  ...
  function refreshClock() {
    ...
    $3("#timer-button")?.style.setProperty("--fill", `${ratio * 100}%`);
  ...
  document.addEventListener("click", (e) => {
    ...
    if (a === "browse-program-old") {
      ...
      show(`${modalHead2(names[p])}<div class="v-choices">${[1, 2, 3].map((l) => `<section class="v-preview-row"><h3>\u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${l}</h3><p>${levelText[p][l - 1]}</p><div class="v-buttons">${["A", "B", "C"].map((a2) => button("\u0627\u0644\u062C\u0644\u0633\u0629 " + a2, "preview", "secondary", `data-workout="${p}-${a2.toLowerCase()}-${l}"`)).join("")}</div></section>`).join("")}</div>${button("\u0643\u0644 \u0627\u0644\u0628\u0631\u0627\u0645\u062C", "preview-all", "text-btn")}`);
      return;
    }
    if (a === "install-app") {
    ...
    if (a === "preview-plan") {
      show(`${modalHead2("\u0645\u0639\u0627\u064A\u0646\u0629 \u062C\u0644\u0633\u0627\u062A \u0627\u0644\u0628\u0631\u0646\u0627\u0645\u062C")}<div class="v-buttons">${["A", "B", "C"].map((l) => button(`\u0627\u0644\u062C\u0644\u0633\u0629 ${l}`, "preview", "secondary", `data-workout="${draftProgram}-${l.toLowerCase()}-${draftLevel}"`)).join("")}</div>`);
      return;
    }
    if (a === "leave") {
  ...
  function programComparison(p) {
    return `${modalHead2(names[p])}<p class="muted">${descriptions[p]}</p><p class="small muted v-space">\u0639\u0644\u0649 \u0627\u0644\u0647\u0627\u062A\u0641\u060C \u0627\u0633\u062D\u0628 \u0627\u0644\u062C\u062F\u0648\u0644 \u0623\u0641\u0642\u064A\u064B\u0627 \u0644\u0645\u0642\u0627\u0631\u0646\u0629 \u0627\u0644\u0645\u0633\u062A\u0648\u064A\u0627\u062A.</p>${["A", "B", "C"].map((letter) => `<h3 class="v-space">\u0627\u0644\u062C\u0644\u0633\u0629 ${letter}</h3><div class="v-comparison" role="region" aria-label="\u0645\u0642\u0627\u0631\u0646\u0629 \u0645\u0633\u062A\u0648\u064A\u0627\u062A \u0627\u0644\u062C\u0644\u0633\u0629 ${letter}" tabindex="0"><table><thead><tr>${[1, 2, 3].map((l) => `<th scope="col">\u0627\u0644\u0645\u0633\u062A\u0648\u0649 ${l}</th>`).join("")}</tr></thead><tbody><tr>${[1, 2, 3].map((l) => {
